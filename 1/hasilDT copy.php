...
if (isset($_GET['testSize'])) {
    ...
    if (mysqli_num_rows($cekdataset) > 0) {
        ...
        $api_url_dt = "http://backend.skripsidonnie.my.id/decision-tree?testSize=$testSize&timestamp=$timestamp";
        ...
        ?>
        <script>
            alert('Dataset Perbandingan belum tersedia, silahkan upload Excel terlebih dahulu!');
...
<head>
    ...
    <title>Decision Tree Analysis | Dataset Perbandingan</title>
            ...
            <div class="col-md-10 mb-3">
                <div class="card">
                    <div class="card-header">
                        <h2>Hasil Decision Tree | Dataset Perbandingan</h2>
                        <h5><strong>Test Size:</strong> <?php echo htmlspecialchars($testSizepy); ?></h5>
                        <h5><strong>Akurasi: </strong>
