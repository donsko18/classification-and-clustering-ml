...
if (isset($_GET['testSize'])) {
    ...
    $cekdataset = mysqli_query($conn, "SELECT * FROM dataset_dt");
    if (mysqli_num_rows($cekdataset) > 0) {
        ...
        $api_url_dt = "http://backend.skripsidonnie.my.id/decision-tree-kombinasi?testSize=$testSize&timestamp=$timestamp";
        ...
        ?>
        <script>
            alert('Dataset hasil K-Means belum tersedia, silahkan ke olah data K-Means terlebih dahulu!');
            ...
            <div class="col-md-10 mb-3">
                <div class="card">
                    <div class="card-header">
                        <h2>Hasil Decision Tree (Label K-Means) | Dataset K-Means</h2>
                        <h5><strong>Test Size:</strong> <?php echo htmlspecialchars($testSizepy); ?></h5>
                        <h5><strong>Akurasi: </strong> <?php echo htmlspecialchars($classification_report['accuracy']); ?></h5>
                    </div>
                </div>
                <!-- Confusion Matrix -->
                <div class="card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post" onsubmit="confirmSave(event)">
                            ...
                            ;
                            ?>
                            <input type="hidden" name="accuracy" value="<?php echo htmlspecialchars($classification_report['accuracy']);
                            ?>">
