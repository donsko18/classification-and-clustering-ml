<?php
include '../koneksi.php';
$cekdataset = mysqli_query($conn, "SELECT * FROM dataset_km");
if (mysqli_num_rows($cekdataset) > 0) {
    // Ambil jumlah cluster dari URL parameter
    // $php_cluster = $_GET['php_cluster'];

    // URL API Flask
    $api_url_kmeans = "http://backend.skripsidonnie.my.id/kmeans-process";
    ...
    ?>
    <script>
        alert('Dataset belum tersedia, silahkan ke kolom dataset K-Means!');
...
<head>
    ...
    if (isset($_POST['historykm'])) {
        ...
        $new_file_name = "scatter_plot" . $timestamp . ".png";
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                        ...
                                        if (mysqli_num_rows($cekquery) > 0) {
                                            ...
                                            foreach ($df as $index => $datas) {
                                                ...
                                                $insertquery = "INSERT INTO
                                                 dataset_dt (id_dt, customer, total_qty, total_harga, label) 
                            ...
                            <form action="" method="post" onsubmit="confirmSave(event)">
                                ...
                                ;
                                ?>
                                <input type="hidden" name="accuracy" value="<?php echo round($silhouette_score, 4);
                                ?>">
